...
const OldStudentInputs = ({ data = null, isLoading = false }) => {
  ...
  const form = useForm({
    ...
    resolver: async (formValues, context, options) => {
      const isGPA = formValues?.study_system_type === "credit_hours";
      const requiredFiles = !!data;
      
      const schema = validationSchema({ requiredFiles: !requiredFiles, isGPA });
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className='space-y-5'>
      ...
      <UploadFilesSection
        ...
        fields={[
          {
            name: "enrollment_proof_image",
            translationKey: "enrollment_proof_image"
          }
        ]}
      />
...
export default OldStudentInputs
