...
const EducationalDepartmentInputs = ({ register, errors, control, setValue = null }) => {
  ...
  return (
      <>
        <Field className="space-y-2">
          <Label text={t("fields:edu_department_name.label")} required />
          <Input 
            {...register("name")} 
            placeholder={t("fields:edu_department_name.placeholder")}
...
export default EducationalDepartmentInputs
